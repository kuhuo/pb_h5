    ...
    <section :class="$style.topicDetail">
      <Row :gutter="24">
        ...
        <Col span="6" class="header-end-col">
          <Button v-if="!topic.has_follow" class="followAboutButton"  :class="$style.unfollow" type="ghost" @click="follow(topic.id)"><PlusIcon height="16" width="16" color="#e20000" />关注</Button>
