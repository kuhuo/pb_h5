          ...
          >
            <Row :gutter="24">
              ...
              <Col span="6" class="header-end-col">
                <Button class="followAboutButton" v-if="type !== 'follow' && !topic.has_follow" :class="$style.unfollow" type="ghost" @click.stop="follow(topic.id, index)"> <PlusIcon height="16" width="16" color="#e20000" />关注</Button>
