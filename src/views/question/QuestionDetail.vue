    ...
    <section :class="$style.detail">
      ...
      <Row :gutter="24" :class="$style.watch">
        ...
        <Col span="12" class="header-end-col">
          ...
          <Button class="followAboutButton" size="small" v-else type="ghost" :class="$style.unFollow" @click.native="follow()"><PlusIcon color="#e20000" width="14" height="14"/>关注 </Button>
        </Col>
      </Row>
                ...
                <Col span="20">
                  <div :class="$style.userTime">
                    <section :class="$style.user">
                      ...
                      <InvitedIcon height="21" width="57" color="#e20000" />
