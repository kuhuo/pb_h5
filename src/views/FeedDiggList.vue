        ...
        <li v-for="(digg, index) in diggList" :class="$style.perDiggParent" :key="index">
          <Row :gutter="24" :class="$style.perDigg">
            ...
            <Col span="4" >
              ...
              <FollowingIcon @click.native="doUnFollowing(digg.user_id)" v-if="digg.is_following && !digg.is_followed && currentUser != digg.user_id" height="21" width="21" color="#e20000" />
              <EachFollowingIcon @click.native="doUnFollowing(digg.user_id)" v-if="digg.is_following && digg.is_followed && currentUser != digg.user_id" height="21" width="21" color="#e20000" />
            </Col>
          </Row>
        </li>
      </div>
