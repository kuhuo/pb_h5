      ...
      <Row :gutter="24">
        ...
        <Col span="5" class="header-end-col">
          ...
          <!--已关注作者,但作者未关注我， 采用取消关注操作-->
            <FollowingIcon  @click.native="handleUnFollowingStatus" height="21" width="21" color="#e20000" v-if="userInfo.follower && !userInfo.following && (userInfo.user_id != currentUser)" />
          <!--相互关注， 采用取消关注操作-->
            <EachFollowingIcon v-if="userInfo.follower && userInfo.following && (userInfo.user_id != currentUser)" @click.native="handleUnFollowingStatus" height="21" width="21" color="#e20000" />
        </Col>
      </Row>
    </header>
