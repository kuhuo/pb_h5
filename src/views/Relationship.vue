      ...
      <Tab-pane label="粉丝" name="followers">
        ...
        >
            ...
            <Col span="4" class="header-end-col" v-if="currentUser == user_id">
              ...
              <FollowingIcon @click.native="doUnFollowing(user.id, index, 'followers')" v-if="!user.following && user.follower && currentUser != user.id" height="21" width="21" color="#e20000" />
              <EachFollowingIcon @click.native="doUnFollowing(user.id, index, 'followers')" v-if="user.following && user.follower && currentUser != user.id" height="21" width="21" color="#e20000" />
            </Col>
          </Row>
        ...
        >
          <Row :gutter="24" v-for="(user, index) in formateList" :key="index" class-name="list">
            ...
            <Col span="4" class="header-end-col" v-if="currentUser == user_id">
              ...
              <FollowingIcon @click.native="doUnFollowing(user.id, index, 'followings')" v-if="!user.following && user.follower && currentUser != user.id" height="21" width="21" color="#e20000" />

              <EachFollowingIcon @click.native="doUnFollowing(user.id, index, 'followings')" v-if="user.following && user.follower && currentUser != user.id" height="21" width="21" color="#e20000" />
