      ...
      <Row :gutter="24">
        ...
        <Col span="5" class="header-end-col" v-if="showFollowButton">
          ...
          <!--已关注作者,但作者未关注我， 采用取消关注操作-->
            <FollowingIcon  @click.native="handleUnFollowingStatus" height="21" width="21" color="#e20000" v-if="userInfo.follower && !userInfo.following" />
          <!--相互关注， 采用取消关注操作-->
            <EachFollowingIcon v-if="userInfo.follower && userInfo.following " @click.native="handleUnFollowingStatus" height="21" width="21" color="#e20000" />
        </Col>
      </Row>
    </header>
