    ...
    <header class="commonHeader" ref="feed-header" v-if="!isWeixin">
      <Row :gutter="24">
        ...
        <Col span="14" class="title-col">
          <div>
            <span :class="$style.newsTitle" style="font-size: 18px; padding: 0 5px">漂泊志详情</span>
          </div>
        </Col>
      </Row>
    </header>
      ...
      >
        <div class="feed-container">
          <div class="feed-container-content feed-background-color markdown-body">
            <h2 v-if="detail.title" style="text-align: left; padding: 15px 12px 12px; font-weight: 400; color: #e20000;margin:0;">{{ detail.title }}</h2>
            <div style="color: #e20000;margin-left:15px; pading:2px;font-size:12px;height:32px;margin-bottom:8px;">
              <span style="border: 1px solid #e20000;display:inline-block;padding:1px;">{{ detail.category.name }}</span>
